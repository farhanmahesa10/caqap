...
const ProductPersonalisation = () => {
  const [data, setData] = useState([
    {
      title: "Memahami Referensi Tingkat Lanjut",
      desc: "Berikan penawaran lebih relevan dan menarik dengan log history preferensi, kebiasaan, dan sejarah pembelian pelanggan.",
    },
    {
      title: "Pesan Yang Disesuaikan Dengan Perilaku",
      desc: "Kirim pesan terpersonalisasi, targetkan penawaran khusus atau rekomendasi produk berdasarkan riwayat pembelian.",
    },
    {
      title: "Pesan Personal Yang Berkelanjutan",
      desc: "Pastikan pesan tersampaikan secara konsisten di seluruh saluran komunikasi, ciptakan kesan personal dan tingkatkan loyalitas.",
    },
  ]);
  ...
  return (
    <section className="wrapper section-break">
      <div className="container">
        <div className="flex flex-col md:flex-row  justify-between gap-[40px] lg:gap-[122px] items-center">
          <div className="order-1 md:order-2 max-w-[600px] w-full">
          ...
          <div className="order-2 md:order-1">
            <img
              src="/images/product/personalisasi.png"
              alt="product efektif"
              className="w-full"
            />
          </div>
...
export default ProductPersonalisation;
