...
const ProductEfective = () => {
  const [data, setData] = useState([
    {
      title: "Kelola Prospek Lebih Efisien",
      desc: "Akses ke berbagai saluran komunikasi untuk temukan pelanggan potensial lebih cepat, tanpa harus berpindah antar platform.",
    },
    {
      title: "Respon Real-time",
      desc: "Notifikasi real-time bantu peningkatan respons peluang hingga konversi berkat momentum yang tepat.",
    },
    {
      title: "Integrasi Chatbot",
      desc: "Dengan integrasi ke fitur chatbot, Anda dapat memulai percakapan awal dengan pelanggan potensial dan berikan kesan yang positif.",
    },
  ]);
  ...
  return (
    <section className="wrapper section-break">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center gap-[40px] lg:gap-[90px] items-center">
          <div>
            <h2 className="main-heading-2 md:text-[37px]">
              Efektif Kelola Leads Generation
            </h2>
          ...
          <div>
            <img
              src="/images/product/efektif.png"
              alt="product efektif"
              className="w-full"
            />
          </div>
...
export default ProductEfective;
