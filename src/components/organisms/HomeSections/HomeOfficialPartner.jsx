  ...
  return (
    <section className="wrapper section-break">
      <div className="container">
        <div
          className="w-full border border-primary rounded-[24px] py-[32px] px-[24px] bg-[#E5F9FF]"
          style={{ boxShadow: "0px 24px 24px 0px #7E9DA726" }}
        >
          ...
          <p className="mt-3 text-center">
            Tingkatkan penjualan dan layanan pelanggan dengan centang hijau
            WhatsApp resmi
          </p>
